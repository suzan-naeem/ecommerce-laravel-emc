                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">@lang('dashboard.editCategory')</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="card-box">
                                ...
                                <form method="POST" action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data" data-parsley-validate novalidate>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input id="name_ar" type="text" name="name_ar" required placeholder="@lang('dashboard.name_ar')" class="form-control" value="{{ $category->name_ar }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="name_en">@lang('dashboard.name_en')</label>
                                        <input id="name_en" type="text" name="name_en" required placeholder="@lang('dashboard.name_en')" class="form-control" value="{{ $category->name_en }}">
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control  select2me" required id="visibility" name="display">
                                            <option {{ $category->display == 0 ? 'selected' : '' }} value="0">@lang('dashboard.hidden')</option>
                                            <option {{ $category->display == 1 ? 'selected' : '' }} value="1">@lang('dashboard.visible')</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @lang('dashboard.edit?')
                                        <img src="{{ $category['image'] }}" width="150" height="100" />
